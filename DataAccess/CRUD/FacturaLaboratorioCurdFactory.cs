...
{
   public class FacturaLaboratorioCurdFactory : CrudFactory
    {
        private FacturaLaboratorioMapper mapper;

        public FacturaLaboratorioCurdFactory() : base()
        {
            mapper = new FacturaLaboratorioMapper();
        ...
        {
            var pedido = (FacturaLaboratorio)entityDTO;
            var sqlOperation = mapper.GetCreateStatement(pedido);
