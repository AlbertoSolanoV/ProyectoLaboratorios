...
{
    public class GananciaCrudFactory : CrudFactory
    {
        private GananciaMapper mapper;

        public GananciaCrudFactory() : base()
        {
            mapper = new GananciaMapper();
        ...
        public List<T> RetrieveByTdAll<T>(int id)
        {
            var list = new List<T>();
