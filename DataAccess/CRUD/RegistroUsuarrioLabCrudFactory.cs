...
{
    public class RegistroUsuarrioLabCrudFactory : CrudFactory
    {
        private RegistroUsuarioLabMapper mapper;

        public RegistroUsuarrioLabCrudFactory() : base()
        {
            mapper = new RegistroUsuarioLabMapper();
